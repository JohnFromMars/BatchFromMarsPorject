...
public class Test0803 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		FileInformtion inputStep1 = new PhysicalFile("INPUT", "d://666.txt", "UTF8", false);
		FileInformtion outputStep1 = new TemporaryFile(1000);
		step1.setInputFile(inputStep1);
		step1.setOutputFile(outputStep1);

		JobTest0803Step2 step2 = new JobTest0803Step2();
		FileInformtion outputStep2 = new TemporaryFile(1000);
		...
		FileInformtion outputStep3 = new PhysicalFile("OUTPUT", "d://test2.txt", "UTF8", true);
